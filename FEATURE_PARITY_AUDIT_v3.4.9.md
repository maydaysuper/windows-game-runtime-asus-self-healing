# Feature Parity Audit v3.4.9

v3.4.9 is a GitHub open-source delivery + classifier-token pass. Core engines are unchanged.
...
RepairCenter.ps1 and PV/HOLTEK/ENE hashes are unchanged from v3.4.8.
