...
<p align="center">
  <a href="https://github.com/maydaysuper/windows-game-runtime-asus-self-healing/releases/download/v4.5.1/Windows_Game_Runtime_ASUS_SelfHealing_Setup_v4.5.1_x64.exe"><strong>下载安装包</strong></a>
  ·
  <a href="https://github.com/maydaysuper/windows-game-runtime-asus-self-healing/releases/download/v4.5.1/Windows_Game_Runtime_ASUS_SelfHealing_Portable_v4.5.1_win-x64.zip">便携版 ZIP</a>
  ·
...
| 包 | 给谁 |
|---|---|
| `Setup_v4.5.1_x64.exe` | 推荐。装到当前用户目录，桌面生成「奥创修复中心」图标 |
| `Portable_v4.5.1_win-x64.zip` | 解压后双击 `SelfHealingCenter.exe` |
...
当前版本：**v4.5.1** · .NET 10 · WPF · Windows 11 x64
