...
WinUI 3 unpackaged builds (v3.4.x) do not start on the target PC. v4.1.4 is WPF / .NET 10 self-contained.
...
v4.1.4 · .NET 10 · C# 14 · WPF · self-contained win-x64 folder deploy
